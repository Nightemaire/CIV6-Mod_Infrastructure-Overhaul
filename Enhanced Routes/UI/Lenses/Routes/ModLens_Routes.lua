...
SubtypeLensLegend = {
	{"LOC_TOOLTIP_LENS_SUBTYPE_PRIMARY",		ModernRoadColor},
    {"LOC_TOOLTIP_LENS_SUBTYPE_SECONDARY",		IndustrialRoadColor},
	{"LOC_TOOLTIP_LENS_SUBTYPE_TERTIARY",		MedievalRoadColor},
	{"LOC_TOOLTIP_LENS_SUBTYPE_RR",				RailroadColor}
}
